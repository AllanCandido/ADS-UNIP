...
| Allan     | 1 hora             | Revisar e aprimorar a introdução e o resumo                     |
...
| Quem fará | Tempo de Execução  | Descrição                                                      | 
|-----------|--------------------|----------------------------------------------------------------|
| Allan     | 1 hora             | Preparar o Termo de Abertura de Projeto                        |
| Allan     | 1 hora             | Criar a Matriz de Papéis e Responsabilidades                   |

### Dia 6: Gerenciamento de Projeto (2 horas)

| Quem fará | Tempo de Execução  | Descrição                                                      | 
|-----------|--------------------|----------------------------------------------------------------|
| Allan     | 1 hora             | Continuar o Termo de Abertura de Projeto                       |
| Allan     | 1 hora             | Completar a Matriz de Papéis e Responsabilidades               |
